...
public class WheelPicker extends View implements IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        int idData = a.getResourceId(R.styleable.WheelPicker_widget_wheel_data, 0);
        if (idData != 0) mData = Arrays.asList(getResources().getStringArray(idData));
        mItemTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_widget_wheel_item_text_size,
                getResources().getDimensionPixelSize(R.dimen.widget_wheel_item_text_size));
        mVisibleItemCount = a.getInt(R.styleable.WheelPicker_widget_wheel_visible_item_count
                , context.getResources().getInteger(R.integer.widget_wheel_visible_item_count));
        mSelectedItemPosition = a.getInt(R.styleable.WheelPicker_widget_wheel_selected_item_position, 0);
        ...
        mSelectedItemTextColor = a.getColor(R.styleable.WheelPicker_widget_wheel_selected_item_text_color
                , ContextCompat.getColor(context, R.color.widget_wheel_selected_item_text_color));
        mItemTextColor = a.getColor(R.styleable.WheelPicker_widget_wheel_item_text_color
                , ContextCompat.getColor(context, R.color.widget_wheel_item_text_color));
        mItemSpace = a.getDimensionPixelSize(R.styleable.WheelPicker_widget_wheel_item_space,
                getResources().getDimensionPixelSize(R.dimen.widget_wheel_item_space));
        ...
        mIndicatorColor = a.getColor(R.styleable.WheelPicker_widget_wheel_indicator_color
                , ContextCompat.getColor(context, R.color.widget_wheel_indicator_color));
        mIndicatorSize = a.getDimensionPixelSize(R.styleable.WheelPicker_widget_wheel_indicator_size,
                getResources().getDimensionPixelSize(R.dimen.widget_wheel_indicator_size));
        mHasCurtain = a.getBoolean(R.styleable.WheelPicker_widget_wheel_curtain, false);
        mCurtainColor = a.getColor(R.styleable.WheelPicker_widget_wheel_curtain_color
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mIsClick && !mIsForceFinishScroll) break;
                mTracker.addMovement(event);
    ...
    public void setSameWidth(boolean hasSameWidth) {
        this.mHasSameWidth = hasSameWidth;
        computeTextSize();
        requestLayout();
        invalidate();
    }
    ...
    public void setMaximumWidthTextPosition(int position) {
        if (!isPosInRang(position))
            throw new ArrayIndexOutOfBoundsException("Maximum width text Position must in [0, " +
                    getItemCount() + "), but current is " + position);
