...
package cn.dujc.widget.zxing.camera;
...
public final class CameraManager {
    ...
    private static final int MIN_FRAME_WIDTH = 420;
//	private static final int MIN_FRAME_HEIGHT = 420;
...
//      }
    ...
    public Rect getFramingRect() {
        if (configManager == null) {//2015年12月23日 15:03:47不知为何崩溃，空指针异常，原因大概在这
            return null;
        }
        Point screenResolution = configManager.getScreenResolution();
        if (screenResolution == null) {//2015年12月23日 15:03:47不知为何崩溃，空指针异常，或者这里
            return null;
        }
        if (framingRect == null) {
            if (camera == null) {
