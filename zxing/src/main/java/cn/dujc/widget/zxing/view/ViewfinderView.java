...
package cn.dujc.widget.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        /*}else{
            ...
            resultColor = resources.getColor(R.color.result_view, theme);
            resultPointColor = resources.getColor(R.color.possible_result_points, theme);
        }*/
...
//      paint.setColor(Color.GREEN);
            ...
            canvas.drawRect(frame.left - CORNER_WIDTH, frame.top - CORNER_WIDTH, frame.left + ScreenRate,
                    frame.top, paint);
            canvas.drawRect(frame.left - CORNER_WIDTH, frame.top, frame.left, frame.top
                    + ScreenRate, paint);
            canvas.drawRect(frame.right - ScreenRate, frame.top - CORNER_WIDTH, frame.right + CORNER_WIDTH,
                    frame.top, paint);
            canvas.drawRect(frame.right, frame.top, frame.right + CORNER_WIDTH, frame.top
                    + ScreenRate, paint);
